...
export const lowerStreetVsRise25: ComparisonPage = {
  ...
  ourCase: {
    ...
    body: [
      ...
      "Where we're genuinely strong is holding a standard across a long catalogue, particularly on technical subjects: 189 episodes for The Genetics Podcast since taking it over at episode 65, and 122 for The Assembly since it launched. That's a narrow claim, deliberately. If you'd like to see the wider market before deciding, our [roundup of B2B podcast production companies](/blog/best-podcast-production-companies-for-b2b) covers more of it, including companies we compete with.",
    ],
  },
  scenarios: [
    {
