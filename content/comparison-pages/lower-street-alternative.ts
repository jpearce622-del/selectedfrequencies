...
export const lowerStreetAlternative: ComparisonPage = {
  ...
  companies: [
    ...
    },
    {
      ...
      strength:
        "Consistency across a long catalogue, and direct access to the person editing your show. We produce The Genetics Podcast for Sano Genetics (189 episodes since taking it over at episode 65) and The Bitcoin Collective (228 episodes since 2021, weekly when it publishes, 4.8/5 on Apple Podcasts).",
      tradeOff:
