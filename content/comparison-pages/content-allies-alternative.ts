...
export const contentAlliesAlternative: ComparisonPage = {
  ...
  companies: [
    ...
    },
    {
      ...
      strength:
        "Transparency and unit cost. Rates are published, so you can budget before speaking to anyone, and you work directly with the person editing the show. Proven on long catalogues — 189 episodes for The Genetics Podcast since taking it over at episode 65, and 122 for The Assembly since it launched.",
      tradeOff:
  ...
  ourCase: {
    ...
    body: [
      ...
      "**You need the standard held over hundreds of episodes.** This is where we're strongest and it's evidenced rather than claimed. The Genetics Podcast has run past 250 episodes with Cambridge researchers and biotech CEOs as guests, 189 of them ours since episode 65; The Bitcoin Collective has published 228 since 2021. Consistency across a long catalogue is a spec-and-process problem, and it's the one we've solved most often.",
