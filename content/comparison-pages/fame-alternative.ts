...
export const fameAlternative: ComparisonPage = {
  ...
  companies: [
    ...
    },
    {
      ...
      strength:
        "Cost transparency and craft consistency. Published rates from £110 per episode, no minimum term, and the person editing your show is the person you talk to. Long-catalogue evidence: 189 episodes for The Genetics Podcast since taking it over at episode 65, and 122 for The Assembly since it launched.",
      tradeOff:
  ...
  ourCase: {
    ...
    body: [
      ...
      "**We won't guarantee growth, and that's deliberate.** We don't control Apple's charts, Spotify's recommendations or whether your guests share the episode — so a promise about audience size would be one we couldn't reliably keep. What we will commit to is a turnaround in working days and a consistent standard across a long catalogue: 189 episodes for The Genetics Podcast since taking it over at episode 65, and 122 for The Assembly since it launched. Those are the things we actually control.",
