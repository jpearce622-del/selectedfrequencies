...
export const caspianStudiosAlternative: ComparisonPage = {
  ...
  companies: [
    ...
    },
    {
      ...
      strength:
        "Doing the ordinary thing extremely consistently, at a price you can see before you call. £110 to £335 per episode by tier, no minimum term, and direct access to the editor. Proven across long catalogues: 189 episodes for The Genetics Podcast since taking it over at episode 65, and 122 for The Assembly since it launched.",
      tradeOff:
