...
// gets cut.
//
// The sections that once carried [MY EXAMPLE HERE] markers now close on a
// stated position rather than an anecdote. That's deliberate and it's the
// standing rule for this file: a claim about how the work behaves is James's
// to make and can be written for him; a specific story about a named show, a
// client's week, or a conversation that happened is not, and must never be
// invented to fill a gap. If James wants a real anecdote in either place it
// replaces the closing paragraph — it doesn't get bolted on beside it.
//
