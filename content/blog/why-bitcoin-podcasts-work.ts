...
export const whyBitcoinPodcastsWork: BlogPost = {
  ...
  sections: [
    {
      id: "the-trust-problem",
      heading: "Bitcoin's trust problem",
      body:
    ...
    {
      id: "why-audio-builds-trust",
      heading: "Why audio is the antidote",
      body:
    ...
    {
      id: "podcasts-as-education",
      heading: "Podcasts are how people actually learn bitcoin",
      body:
    ...
    {
      id: "who-its-for",
      heading: "Who should have a bitcoin podcast",
      body:
    ...
    {
      id: "how-to-start",
      heading: "How to start (or level up) your bitcoin podcast",
      body:
        "If all of this has you thinking about your own show — whether you're a founder, a fund, an educator, or a business that wants a credible voice in the space — here's the practical shape of it.\n\n**Get the fundamentals right first.** Nail a clear concept and format, sort out the minimum viable gear, and get comfortable recording before you worry about anything fancy. Our interactive [nine-step launch checklist](/podcast-launch-roadmap) walks through the whole path from idea to published episode.\n\n**Commit to a cadence you can actually sustain.** Consistency beats frequency every time. A reliable episode every two weeks that you keep up for years will out-perform a weekly burst that burns out in three months. Choose the rhythm you can hold through a bear market, then hold it.\n\n**Invest in audio quality from day one.** In a trust-first space, sound *is* substance. Broadcast-ready audio signals that you take the subject — and your listener — seriously. Our [producer's guide to audio quality](/blog/podcast-audio-quality-guide) covers exactly how.\n\n**Make every episode discoverable and repeatable.** Publish video, cut clips, write proper show notes and transcripts so search engines can actually find you. (See our guides to [podcast SEO](/blog/podcast-seo-guide) and [repurposing content](/blog/repurpose-podcast-content), and think in terms of the [metrics that actually matter](/blog/podcast-analytics-metrics-that-matter) rather than vanity downloads.)\n\n**Then protect your own time for the part only you can do — the conversation.** The research, editing, show notes, clips, and distribution are enormous, repetitive work, and they're exactly the part that quietly kills shows when a busy founder tries to do it all alone. It's the reason both Bitcoin and the Long Game and The Bitcoin Collective hand their production to us: so the hosts can focus entirely on showing up, week after week, and being worth listening to. If you're building something serious in this space and want it to sound like it, [that's a conversation we'd love to have](/contact).",
    },
  ],
  references: [
    {
    ...
    {
      label: "Bitcoin.org — introductory education on how bitcoin works",
      url: "https://bitcoin.org/en/getting-started",
    },
    {
      label: "Edison Research — podcast audience and listening behaviour",
      url: "https://www.edisonresearch.com/",
    },
    {
      label: "Apple Podcasts for Creators",
      url: "https://podcasters.apple.com/",
    },
    {
      label: "Podnews — podcasting industry news and data",
